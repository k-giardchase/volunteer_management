<?php
    ...
    class Committee
    {
        ...
        function delete()
        {
            ...
            $GLOBALS['DB']->exec("DELETE FROM committees_events WHERE committee_id = {$this->getId()};");
            $GLOBALS['DB']->exec("DELETE FROM committees_supervisors WHERE committee_id = {$this->getId()};");
